...
export class Service {
  ...
  authenticate(user: User)
   {
    console.log("Hi")
    return this.http.post<any>("http://localhost:9085/token", user)
  ...
  pensionerDetails(){
    // console.log(localStorage.getItem("token"));
    return this.http.get<any>("http://localhost:9085/details",{headers: new HttpHeaders().set('Authorization', "Bearer " + localStorage.getItem("token"))})
  ...
  processPension(pensionInput:ProcessPensionInput){
    return this.http.post<any>("http://localhost:9085/processPension", pensionInput,{headers: new HttpHeaders().set('Authorization', "Bearer " + localStorage.getItem("token"))})
  ...
  pensionDetail(pensionerInput:PensionerInput){
    return this.http.post<any>("http://localhost:9085/pensionDetail", pensionerInput,{headers: new HttpHeaders().set('Authorization', "Bearer " + localStorage.getItem("token"))})
  ...
  detailsByAadhar(aadharNumber:number){
    return this.http.get<PensionerDetail>("http://localhost:9081/pensionerDetail/"+aadharNumber,
